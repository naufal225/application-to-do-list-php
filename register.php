...
<body class="font-[Poppins] min-h-screen w-full bg-[black] flex justify-center items-center">
    ...
    <div class="xl:w-3/12 w-9/12 min-h-[60vh] bg-white rounded-lg flex flex-col justify-evenly items-center mx-auto">
        <h1 class="text-4xl font-bold mb-5 mt-5">Registerasi</h1>
        <form action="" method="post" class="w-full max-w-sm">
            <div class="mb-4 md:ml-7">
            ...
            <button type="submit" name="submit" class="md:w-9/12 mt-3 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ml-36 md:ml-11">Daftar</button>
        </form>
        <div class="">
